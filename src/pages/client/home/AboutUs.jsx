		...
		<div className="w-full">
			<div className="container mx-auto xl:pt-16 xl:pb-8">
				<div className="relative px-2 mx-auto w-[360px] sm:w-[420px] lg:w-[528px] py-8 xl:py-0 h-[504px]">
					<div className="absolute w-[200px] rounded-lg h-[120px] shadow-lg bg-gray-900">
						<Typography className="absolute text-base font-bold text-blue-gray-50 left-8 top-12 md:text-lg lg:text-xl">
							~ About Us
						</Typography>
					</div>
					<div className="absolute w-[270px] top-28 p-4 end-2 h-[224px] lg:w-[360px] rounded-lg xl:h-[260px] xl:top-20 md:w-[320px] bg-gray-50 shadow-md">
					...
					<div className="absolute w-[240px] lg:w-[254px] bottom-20 p-4 h-[108px] rounded-lg bg-gray-900 shadow-lg">
						<Typography className="absolute p-2 text-sm md:text-base top-8 text-blue-gray-50">
							Based in Mojokerto
						</Typography>
					</div>
					<div className="absolute w-[60px] bottom-8 left-1/2 -translate-x-1/2 p-4 h-[60px] rounded-lg bg-gray-50 shadow-md">
