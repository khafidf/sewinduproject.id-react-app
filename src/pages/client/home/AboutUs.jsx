		...
		<div className="w-full">
			<div className="container py-16 mx-auto">
				<div className="relative px-2 mx-auto w-[360px] sm:w-[420px] lg:w-[528px] py-4 h-[504px]">
					...
					<div className="absolute w-[270px] top-24 p-4 end-2 rounded-none h-[224px] lg:w-[360px] md:w-[320px] bg-gray-50 shadow-md">
						<Typography className="px-2 py-8 text-sm md:text-base md:py-6 text-blue-gray-900">
					...
					<div className="absolute w-[240px] lg:w-[254px] bottom-24 p-4 rounded-none h-[108px] bg-gray-900 shadow-md">
						<Typography className="absolute p-2 text-sm md:text-base top-8 text-blue-gray-50">
							Based in Mojokerto
						</Typography>
					</div>
					<div className="absolute w-[60px] bottom-12 left-1/2 -translate-x-1/2 p-4 rounded-none h-[60px] bg-gray-50 shadow-md">
